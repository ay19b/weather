  ...
  return (
    <aside className='sidebar'>
      <div className='sidebar-container'>
        ...
        <ul className='cities'>
          <li>
            <button className='city' onClick={() => searchCity('Alger')}>
              Alger
            </button>
          </li>
          <li>
            <button className='city' onClick={() => searchCity('Setif')}>
              Setif
            </button>
          </li>
          <li>
            <button className='city' onClick={() => searchCity('Oran')}>
              Oran
            </button>
          </li>
          <li>
            <button className='city' onClick={() => searchCity('Bejaia')}>
              Bejaia
            </button>
          </li>
        </ul>
